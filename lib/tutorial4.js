...
light.position.set(0.1, 3.9, -0.2);
...
gltfLoader1.load("assets/locker/scene.gltf", (gltfScene) => {
  gltfScene.scene.children[0].position.y = -1;
  gltfScene.scene.children[0].position.x = -5.8 + 0.1;
  gltfScene.scene.children[0].position.z = -3.7 + 0.5;

  gltfScene.scene.children[0].scale.set(0.015, 0.01, 0.013);
...
gltfLoader1.load("assets/lightbulb/scene.gltf", (gltfScene) => {
    gltfScene.scene.children[0].rotation.y =  Math.PI;
  gltfScene.scene.children[0].position.y = 3.95;
  gltfScene.scene.children[0].position.x = 0 + 0.1;
...
let gltfLoader25 = new THREE.GLTFLoader();
gltfLoader1.load("assets/doormat/scene.gltf", (gltfScene) => {
  gltfScene.scene.children[0].rotation.z = 2*Math.PI;
  gltfScene.scene.children[0].position.y = -1.3 + 0.4;
  gltfScene.scene.children[0].position.x = -1 ;
  gltfScene.scene.children[0].position.z = 8 ;

  gltfScene.scene.children[0].scale.set(.03, .03, .03);
  scene.add(gltfScene.scene.children[0]);
});

let gltfLoader26 = new THREE.GLTFLoader();
gltfLoader1.load("assets/shoes/scene.gltf", (gltfScene) => {
  gltfScene.scene.children[0].rotation.z = -Math.PI/2;
  gltfScene.scene.children[0].position.y = -0.6 + 0.4;
  gltfScene.scene.children[0].position.x = -3.17 + 0.1;
  gltfScene.scene.children[0].position.z = -1 + 3.3 + 1.5;

  gltfScene.scene.children[0].scale.set(2,2, 2);
  scene.add(gltfScene.scene.children[0]);
});

let gltfLoader27 = new THREE.GLTFLoader();
gltfLoader1.load("assets/books/scene.gltf", (gltfScene) => {
  gltfScene.scene.children[0].rotation.z = Math.PI/2;
  gltfScene.scene.children[0].position.y = 0.53;
  gltfScene.scene.children[0].position.x = 3.4;
  gltfScene.scene.children[0].position.z = 2.3 - 1.8;

  gltfScene.scene.children[0].scale.set(.009, .009, .009);
  scene.add(gltfScene.scene.children[0]);
});

let gltfLoader28 = new THREE.GLTFLoader();
gltfLoader1.load("assets/books/scene.gltf", (gltfScene) => {
  gltfScene.scene.children[0].rotation.z = Math.PI/2;
  gltfScene.scene.children[0].position.y = 0.53-0.4;
  gltfScene.scene.children[0].position.x = 3.4;
  gltfScene.scene.children[0].position.z = 2.3 - 1.8;
...
let gltfLoader29 = new THREE.GLTFLoader();
gltfLoader1.load("assets/stationary/scene.gltf", (gltfScene) => {
  gltfScene.scene.children[0].rotation.z = -Math.PI;
  gltfScene.scene.children[0].position.y = 0.3;
  gltfScene.scene.children[0].position.x = -3.5 + 0.1;
  gltfScene.scene.children[0].position.z = -0.1 + 0.5;

  gltfScene.scene.children[0].scale.set(.1, .1, .1);
  scene.add(gltfScene.scene.children[0]);
});

let gltfLoader30 = new THREE.GLTFLoader();
gltfLoader1.load("assets/light_switch/scene.gltf", (gltfScene) => {
  gltfScene.scene.children[0].rotation.z = Math.PI;
  gltfScene.scene.children[0].position.y = 1.2;
  gltfScene.scene.children[0].position.x = 0;
  gltfScene.scene.children[0].position.z = 3.25 + 3.8 - 0.7;

  gltfScene.scene.children[0].scale.set(4.03, 4.03, 4.03);
  scene.add(gltfScene.scene.children[0]);
});

let gltfLoader31 = new THREE.GLTFLoader();
gltfLoader1.load("assets/shower/scene.gltf", (gltfScene) => {
  gltfScene.scene.children[0].rotation.z = -Math.PI / 2;
  gltfScene.scene.children[0].position.y = 0.8;
  gltfScene.scene.children[0].position.x = 4 - 0.1;
  gltfScene.scene.children[0].position.z = 0.8 + 3.6 + 1.5 - 0.7;

  gltfScene.scene.children[0].scale.set(2.03, 2.03, 2.03);
  scene.add(gltfScene.scene.children[0]);
});

let gltfLoader32 = new THREE.GLTFLoader();
gltfLoader1.load("assets/bucket/scene.gltf", (gltfScene) => {
  gltfScene.scene.children[0].rotation.z = -Math.PI / 2;
  gltfScene.scene.children[0].position.y = -0.5;
  gltfScene.scene.children[0].position.x = 3.5 - 0.1;
  gltfScene.scene.children[0].position.z = 0.8 + 3.6 + 1.5 - 0.7;

  gltfScene.scene.children[0].scale.set(.013, .013, .013);
  scene.add(gltfScene.scene.children[0]);
});

let gltfLoader33 = new THREE.GLTFLoader();
gltfLoader1.load("assets/toilet_door/scene.gltf", (gltfScene) => {
  gltfScene.scene.children[0].rotation.z = -Math.PI / 8;
  gltfScene.scene.children[0].position.y = -0.5;
  gltfScene.scene.children[0].position.x = 0.9;
  gltfScene.scene.children[0].position.z = 3.6 + 1.5 - 0.7;

  gltfScene.scene.children[0].scale.set(.02, .013, .015);
  scene.add(gltfScene.scene.children[0]);
});

let gltfLoader34 = new THREE.GLTFLoader();
gltfLoader1.load("assets/toilet_door/scene.gltf", (gltfScene) => {
  gltfScene.scene.children[0].rotation.z = -Math.PI / 8;
  gltfScene.scene.children[0].position.y = -0.5;
  gltfScene.scene.children[0].position.x = 0.9;
  gltfScene.scene.children[0].position.z = 6.3 + 1.5 - 0.7;
...
let loader = new THREE.AudioLoader().load("assets/audio/allthat.mp3",
(hasil)=>{
...
addEventListener("keydown", (e) => {
  ...
  let checkLight = scene.getObjectByName("light1");
